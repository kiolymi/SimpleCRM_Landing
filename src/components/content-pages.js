import { createArticleCard } from './article-card.js?v=20260907-50';
...
import { articles, categoryMeta, findArticles, getArticleBySlug, getArticlesByCategory } from '../data/articles.js?v=20260908-70';
